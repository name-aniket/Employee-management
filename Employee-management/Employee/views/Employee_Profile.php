...
if (isset($_SERVER['HTTP_REFERER']) && stristr($_SERVER['HTTP_REFERER'], 'Employee.php') && isset($_GET) && !empty($_GET['*'])) {
    /**
     * Database connection
     */
    ...
    $data  = Employee::EmployeeProfileDetail(base64_decode($_GET['*']));
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="profile-info-left">
                                                        ...
                                                        <div class="staff-msg"><a class="btn btn-custom" href="javascript:void(0)">Send OTP</a></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                ...
                                <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted">This is a paragraph which describes about the project.
                                            </p>
                                            ...
                                            <div class="project-members m-b-15">
                                                ...
                                                <ul class="team-members">
                                                    <li>
                                                        <a href="#" data-toggle="tooltip" title="Jeffery Lalor"><img alt="" src="../../assets/img/logo.png"></a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="project-members m-b-15">
                                                ...
                                                <ul class="team-members">
                                                    <li>
                                                        <a href="#" data-toggle="tooltip" title="John Doe"><img alt="" src="../../assets/img/logo.png"></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" data-toggle="tooltip" title="Richard Miles"><img alt="" src="../../assets/img/logo.png"></a></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" data-toggle="tooltip" title="John Smith"><img alt="" src="../../assets/img/logo.png"></a>
                                                    </li>
                                                    <li>
                                                        <a href="#" data-toggle="tooltip" title="Mike Litorus"><img alt="" src="../../assets/img/logo.png"></a>
                                                    </li>
                                                    <li>
